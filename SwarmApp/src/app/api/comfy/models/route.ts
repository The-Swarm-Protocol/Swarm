 ...
 *
 * Returns available checkpoints, samplers, and schedulers from the connected ComfyUI instance.
 * Useful for populating generation form dropdowns.
 *
 * Auth: org member
 */
...
import { isComfyConfigured, getModels, getSamplers, getSchedulers } from "@/lib/comfyui";
