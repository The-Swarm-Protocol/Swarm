        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className={`text-sm flex items-center gap-1.5 ${agent.status === "online" ? "text-amber-600" : "text-gray-400"}`}>
                <span className={`w-2.5 h-2.5 rounded-full ${agent.status === "online" ? "bg-amber-500" : "bg-gray-300"}`} />
                {agent.status}
              </span>
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-amber-600">{agent.winRate}%</div>
