...
curl -L -o scripts/swarm.mjs "https://swarm.perkos.xyz/swarm-connect/swarm.mjs?v=3"
curl -L -o package.json "https://swarm.perkos.xyz/swarm-connect/package.json?v=3"
npm install
\`\`\`
