                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className={`text-xs flex items-center gap-1 ${agent.status === "online" ? "text-blue-600" : "text-gray-400"}`}>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-2 gap-3 pt-3 border-t border-gray-100">
                  <div>
                    ...
                    <div className={`text-lg font-bold ${agent.winRate >= 65 ? "text-blue-600" : agent.winRate >= 55 ? "text-yellow-600" : "text-red-500"}`}>
                      {agent.winRate}%
                    </div>
                  </div>
                  <div>
