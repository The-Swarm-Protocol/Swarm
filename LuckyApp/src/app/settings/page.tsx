    ...
    <main className="min-h-[calc(100vh-4rem)] p-6 md:p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-500">Manage your organization profile</p>
        </div>
            ...
            <form onSubmit={handleSave} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 resize-none"
                />
              </div>
