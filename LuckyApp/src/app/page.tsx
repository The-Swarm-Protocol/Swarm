        ...
        <div className="text-center max-w-3xl mx-auto px-6">
          ...
          <div className="mt-12 grid grid-cols-5 gap-4 text-center text-sm">
            {["Trading", "Research", "Operations", "Support", "Gaming"].map((use) => (
              <div key={use} className="rounded-lg border border-border py-3 px-2 text-muted-foreground font-medium">
                {use}
              </div>
            ))}
          </div>
          <div className="mt-12 grid grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground mt-1">Autonomous Ops</div>
            </div>
          </div>
        </div>
      </main>
